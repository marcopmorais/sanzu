      ...
      <div className="panel grid">
        <div className="grid two">
          <section className="panel">
            ...
            <p className="meta">Choose your plan tier. Card payment only. Proration preview and confirmation checkpoint.</p>
            <ul aria-label="Available plans">
              <li>Inicial — €49/month — 10 cases included</li>
              <li>Profissional — €99/month — 30 cases included</li>
              <li>Agência — €199/month — 80 cases included</li>
            </ul>
