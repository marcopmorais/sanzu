...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sanzu.Core.Entities.AdminDashboardSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AdminDashboardSnapshots", (string)null);
                });

            modelBuilder.Entity("Sanzu.Core.Entities.AgencyPlaybook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("AgencyPlaybooks", (string)null);
                });
            ...
            modelBuilder.Entity("Sanzu.Core.Entities.Case", b =>
                {
                    ...
                    b.Property<int?>("PlaybookVersion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sanzu.Core.Entities.RemediationAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("QueueId", "QueueItemId");
            ...
            modelBuilder.Entity("Sanzu.Core.Entities.TenantHealthScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("BillingScore")
                        .HasColumnType("int");

                    b.Property<int>("CaseCompletionScore")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PrimaryIssue")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("TenantHealthScores", (string)null);
                });
            ...
            modelBuilder.Entity("Sanzu.Core.Entities.UserRole", b =>
                {
                    ...
                    b.ToTable("UserRoles", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserRoles_RoleType", "[RoleType] IN ('AgencyAdmin','SanzuAdmin','SanzuOps','SanzuFinance','SanzuSupport','SanzuViewer')");
                        });
                });
