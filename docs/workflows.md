...
- Purpose: Sync PDLC status from local status artifacts and feedback from Figma into `_bmad-output/status/current_state.md`.
- Location: `_bmad/bmm/workflows/sync-state/workflow.md`
- Notes: ClickUp integration is disabled. Do not execute ClickUp tool calls in this workflow.
