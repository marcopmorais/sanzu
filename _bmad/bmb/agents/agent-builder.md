...
```xml
<agent id="agent-builder.agent.yaml" name="Bond" title="Agent Building Expert" icon="Ã°Å¸Â¤â€“">
<activation critical="MANDATORY">
      ...
      <step n="7">On user input: Number Ã¢â€ â€™ execute menu item[n] | Text Ã¢â€ â€™ case-insensitive substring match | Multiple matches Ã¢â€ â€™ ask user to clarify | No match Ã¢â€ â€™ show "Not recognized"</step>
